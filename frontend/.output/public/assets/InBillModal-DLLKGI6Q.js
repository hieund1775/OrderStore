import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{l as t,t as n}from"./button-ZXrziPDy.js";import{t as r}from"./jsx-runtime-By8HlURe.js";import{n as i,t as a}from"./browser-DtZcc0fk.js";import{t as o}from"./x-KFw41sMv.js";import{E as s,F as c,L as l,P as u,R as d,o as f,u as p}from"./index-Bj2wN2Vm.js";var m=e(t(),1),h=e(a(),1),g=r();function _(e,t){let n=e.items.map(e=>{let t=[e.size_label||null,e.toppings&&e.toppings.length>0?e.toppings.map(e=>e.name).join(`, `):null,e.note?`(${e.note})`:null].filter(Boolean).join(` · `);return`
        <tr>
