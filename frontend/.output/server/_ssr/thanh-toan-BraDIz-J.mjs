...
import { b as vnd, h as stores, t as Button } from "./data-BKElHwIS.mjs";
import { t as Input } from "./input-DvwfGdEz.mjs";
import { P as MapPin, d as Store, dt as Bike, u as Ticket } from "../_libs/lucide-react.mjs";
import { _ as useNavigate, g as Link, v as useSearch } from "../_libs/@tanstack/react-router+[...].mjs";
import { i as apiPost, n as apiGet } from "./api-CyIKtyVS.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/thanh-toan-BraDIz-J.js
...
function Checkout() {
	...
	const [branch, setBranch] = (0, import_react.useState)(stores[0].id);
