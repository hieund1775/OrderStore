...
import { C as Plus, P as MapPin, R as LoaderCircle, T as Pencil, c as Trash2, nt as Clock, w as Phone, y as Search } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/admin.chi-nhanh-B7jJCZ3r.js
...
function StoreFormDialog({ store, onSave, onClose }) {
	...
	const [isActive, setIsActive] = (0, import_react.useState)(store ? Boolean(store.is_active) : true);
