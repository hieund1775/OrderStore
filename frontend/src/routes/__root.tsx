  ...
  if (isAdmin) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-muted/30 px-4">
        <div className="max-w-md text-center bg-card border rounded-2xl p-8 shadow-card-soft">
          <h1 className="text-6xl font-bold text-foreground">404</h1>
          <h2 className="mt-3 text-lg font-semibold text-foreground">Không tìm thấy trang quản trị</h2>
          <p className="mt-2 text-sm text-muted-foreground">
            Đường dẫn quản trị bạn vừa truy cập không tồn tại hoặc đã được thay đổi.
          </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Trà Trái Cây Tô" },
