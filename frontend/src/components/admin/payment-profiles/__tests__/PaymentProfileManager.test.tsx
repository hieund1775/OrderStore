...
describe('PaymentProfileManager Super Admin Suite', () => {
  ...
  const sampleProfiles: api.PaymentProfile[] = [
    ...
    },
    {
      ...
      env_prefix: 'PAYOS_PROFILE_GROUP_CHECKOUT',
      env_keys: {
        client_id: 'PAYOS_PROFILE_GROUP_CHECKOUT_CLIENT_ID',
        api_key: 'PAYOS_PROFILE_GROUP_CHECKOUT_API_KEY',
        checksum_key: 'PAYOS_PROFILE_GROUP_CHECKOUT_CHECKSUM_KEY',
      },
