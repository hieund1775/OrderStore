...
import { Eye, EyeOff, Leaf, Lock, Phone, Check } from 'lucide-react-native';
...
export default function LoginScreen() {
  ...
  // Load saved credentials if user previously checked "Nhớ mật khẩu"
  useEffect(() => {
      ...
      try {
        if (rememberPassword) {
          await SecureStore.setItemAsync(
            'saved_credentials',
            JSON.stringify({ phone: targetPhone, password: targetPass })
          );
        } else {
    ...
    >
      ...
      >
        ...
        <View style={styles.card}>
          ...
          {/* Remember Password & Forgot Password Link */}
          <View style={styles.actionRow}>
            ...
            >
              <View style={[styles.checkbox, rememberPassword && styles.checkboxActive]}>
                {rememberPassword && <Check size={12} color="#ffffff" strokeWidth={3} />}
              </View>
