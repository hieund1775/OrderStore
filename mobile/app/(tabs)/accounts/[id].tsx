...
const DEFAULT_DEMO_ACCOUNTS: StaffAccount[] = [
  { id: 1, fullname: 'Super Administrator', email: 'superadmin@teaplus.vn', role: 'super', branch: 'Toàn hệ thống', active: true },
  { id: 2, fullname: 'Quản lý Chi nhánh 1', email: 'manager1@teaplus.vn', role: 'manager', branch: 'TeaPlus Quận 1 - Nguyễn Huệ', active: true },
  { id: 3, fullname: 'Thu ngân Chi nhánh 1', email: 'cashier1@teaplus.vn', role: 'cashier', branch: 'TeaPlus Quận 1 - Nguyễn Huệ', active: true },
  { id: 4, fullname: 'Đầu bếp Chi nhánh 1', email: 'kitchen1@teaplus.vn', role: 'kitchen', branch: 'TeaPlus Quận 1 - Nguyễn Huệ', active: true },
  { id: 6, fullname: 'Nhân viên Soạn hàng Chi nhánh 1', email: 'packing1@teaplus.vn', role: 'packing', branch: 'TeaPlus Quận 1 - Nguyễn Huệ', active: true },
];
  ...
  const loadAccount = useCallback(async () => {
    ...
    try {
      ...
      if (found) {
        ...
        setAccount(DEFAULT_DEMO_ACCOUNTS[0]);
      }
    } finally {
      setLoading(false);
    }
