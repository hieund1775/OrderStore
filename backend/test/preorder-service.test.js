...
function harness(overrides = {}) {
  ...
  const repository = {
    ...
    async findCurrentCheckinRequest() { return { id: 101, status: 'PENDING', requested_at: now }; },
    async confirmCheckinRequest() { return { id: 101, status: 'CONFIRMED' }; },
    async rejectCheckinRequest() { return { id: 101, status: 'REJECTED' }; },
    async markCheckinRequestRescheduled() { return []; },
    async recordSlotStrikeOnce() { return { id: 201 }; },
    async markCheckinManagerBreachOnce() { return { id: 101 }; },
