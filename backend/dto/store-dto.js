export function toStoreDto(store) {
  ...
  return {
    ...
    table_count: store.table_count == null ? 0 : Number(store.table_count),
    today_orders: store.today_orders == null ? 0 : Number(store.today_orders),
    today_revenue: store.today_revenue == null ? 0 : Number(store.today_revenue),
